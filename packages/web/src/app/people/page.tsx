  ...
  if (!authLoading && !myAgent) {
    return (
      <div className="flex flex-col items-center justify-center h-screen text-white">
        <p className="text-sm text-zinc-500 mb-4">Sign in to see your people</p>
        <Link
          href="/login"
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-[11px] text-zinc-600 truncate font-mono mt-0.5">
                        {p.email}
                      </p>
                      {p.departments.length > 0 && (
                        <div className="flex flex-wrap gap-1 mt-2">
                          {p.departments.slice(0, 3).map((d) => (
                            <span
                              key={d}
                              className="text-[10px] px-2 py-0.5 rounded-full bg-elevated text-zinc-400 border border-white/[0.1]"
                            >
                              {d}
                            </span>
                          ))}
