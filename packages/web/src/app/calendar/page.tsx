...
// Internal IDs for the four supported views. The old "list" / "board"
// tabs were renamed and collapsed: "day" is the per-day list, "week" is
// the seven-column board with a detail panel on top.
...
function weekGrid(anchor: Date): Date[] {
  // Monday-start: getDay() returns 0 for Sunday, 1..6 for Mon..Sat.
  // Sunday wraps back to the previous Monday (offset -6); other days use
  // 1 - day so Monday lands on Monday.
...
function WeekView({
  ...
  return (
    <div>
      {/* Selected day's deadlines + meetings on top, then the 7-day grid. */}
      <DayDetailPanel day={selectedDay} items={dayItems(selectedDay)} />
      <div className="p-6">
            ...
            return (
              ...
              >
                <div className="flex items-baseline justify-between mb-2 gap-1">
                  <span className="text-[11px] uppercase tracking-wide text-dusk truncate">
