...
async def alter_table_if_needed():
    ...
    statements: list[str] = [
            ...
            #     partner demo. Real customers should never see them in
            #     their People list. Per-statement transactions mean a
            #     missing table or FK on any one of these doesn't poison
            #     the rest. UUIDs match agents/seed.py constants. ---
            ...
            "DELETE FROM tasks WHERE agent_id IN ('00000000-0000-0000-0000-000000000001','00000000-0000-0000-0000-000000000002','00000000-0000-0000-0000-000000000003','00000000-0000-0000-0000-000000000004')",
